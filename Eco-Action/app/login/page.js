...
// // //           {error && (
// // //             <div className="text-red-500 text-sm bg-red-100 border border-red-400 rounded p-2">
// // //               {error}
// // //             </div>
// // //           )}
...
// //             <button
// //               type="submit"
// //               className="group relative w-full flex justify-center py-2 px-4 border border-transparent text-sm font-medium rounded-md text-white bg-green-600 hover:bg-green-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-500 transition duration-150 ease-in-out transform hover:scale-105"
// //             >
// //               Sign in
// //             </button>
// //           </div>
...
// //             By signing in, you're contributing to a greener future.
// //             <br />
// //             Every login plants a virtual seed! 🌱
// //           </p>
// //         </div>
// //       </div>
// //     </div>
