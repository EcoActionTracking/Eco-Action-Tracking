...
const ChallengeList = ({ challenges, onPageChange, onEdit, onDelete }) => {
  ...
  const getDifficultyColor = (difficulty) => {
    const colors = {
      beginner: "bg-[#C2DEDC] text-[#122e33]", // Changed to specified colors
      intermediate: "bg-gray-200 text-gray-800",
                  ...
                  <td className="py-4 px-6 text-gray-800">
                    <div className="flex items-center space-x-4">
                      <motion.button
                        ...
                        className="text-[#116A7B] hover:text-[#122e33] transition duration-300"
                      >
