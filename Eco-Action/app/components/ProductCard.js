...
//                 {product.name}
//               </h2>
//               <p className="text-sm text-[#7AB2B2] mb-2">
//                 {product.description}
//               </p>
//               <span className="text-xs font-semibold text-[#4D869C] bg-[#CDE8E5] px-2 py-1 rounded-full">
//                 {product.category}
//               </span>
//             </div>
//             <div className="mt-2">
...
//           />
//           <div className="absolute top-0 right-0 bg-[#7AB2B2] text-white px-2 py-1 m-1 rounded-md text-xs font-semibold">
//             ${product.price.toFixed(2)}
//           </div>
//         </div>
//         <div className="p-4">
//           <h2 className="text-lg font-bold mb-1 text-[#4D869C]">
//             {product.name}
//           </h2>
//           <p className="text-xs text-[#7AB2B2] mb-2 line-clamp-2">
//             {product.description}
//           </p>
...
//                 addToCart();
//               }}
//               className="flex items-center justify-center bg-[#4D869C] text-white px-3 py-1 rounded-lg hover:bg-[#7AB2B2] transition-colors duration-300 text-xs"
//             >
